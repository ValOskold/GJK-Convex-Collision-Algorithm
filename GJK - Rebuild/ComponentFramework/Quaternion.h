...
namespace  MATH {
	...
	struct Quaternion : public Vec3 { 
		...
		// SUN code up a normalize method
		...
		// SUN code up a += quaternion and a * float
		// For Kevin in Unity, you may want to code something like this:
		...
		//For Kevin in Unity, you may want to code something like this:
		//Quaternion multiplyFloat(float s) {
		//	Quaternion result;
		//	result.w *= s;
		//	result.x *= s;
		//	result.y *= s;
